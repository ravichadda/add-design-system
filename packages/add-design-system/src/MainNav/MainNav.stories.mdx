...
import Write from '@add/icons/Write';
import Layer from '@add/icons/Layer';
import Landscape from '@add/icons/Landscape';
import Information from '@add/icons/Information';
import Puzzle from '@add/icons/Puzzle';
import ShoppingCart from '@add/icons/ShoppingCart';
import Cog from '@add/icons/Cog';
...
import {
  ...
  NavUser,
  NavLink,
} from '@add/design-system/MainNav';
```
